        ...
        <Container>
          <Row className="header-box  d-flex align-items-center pt-lg-5">
            ...
            <p className="mb-4 animate__animated animate__fadeInUp animate__delay-1s">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Officia temporibus sit repellat aspernatur provident sapiente!</p>
                <button className="btn btn-danger btn-lg rounded-1 me-2 mb-xs-0 mb-2
                animate__animated animate__fadeInUp animate__delay-1s">Lihat Kelas</button>
                <button className="btn btn-outline-danger btn-lg rounded-1 mb-xs-0 mb-2
                animate__animated animate__fadeInUp animate__delay-1s"onClick={() => navigate("/kelas")}>Lihat Promo</button>
            </Col>
          ...
          <Row>
            {kelasTerbaru.map((kelas)=> {
              ...
              data-aos-delay={kelas.delay}>
                <img src={kelas.image} alt="unsplash.com" className="w-100mb-5 rounded-top" />
